	...
	maristaschileStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Lista 123 azul', element: 'ol', attributes: { 'class': 'bck-ol bck-ol1' } },
				{ name: 'Lista abc azul', element: 'ol', attributes: { 'class': 'bck-ol bck-ol2' } },
				{ name: 'Lista 123 roja', element: 'ol', attributes: { 'class': 'bck-ol bck-ol3' } },
